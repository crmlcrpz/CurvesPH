...
class MembersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // On member transfer update inquiry Status
            if ($request->has('transfer_id')) {
                $inquiry = Inquiry::findOrFail($request->transfer_id);
    ...
    public function transfer($id, Request $request)
    {
        ...
        return view('members.transfer', compact('inquiry', 'invoice_number', 'invoiceCounter', 'member_code', 'memberCounter', 'member_number_mode', 'invoice_number_mode'));
    }
}
