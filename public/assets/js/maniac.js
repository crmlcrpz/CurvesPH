var curves = (function($) {
	...
	loadmorris: function () {
                ...
                var line = new Morris.Line({
                    element: 'curves-registrations-trend',
                    resize: true,
                ...
                var donut = new Morris.Donut({
                    element: 'curves-members-per-plan',
                    resize: true,
	...
	loaddaterangepicker: function () {
	    function cb(start, end) {
	        $('.curves-daterangepicker span').html(moment(start).format('YYYY-MM-DD') + ' - ' + moment(end).format('YYYY-MM-DD'));
	    ...
	    $('.curves-daterangepicker').daterangepicker({
	        ranges: {
	           'Today': [moment(), moment()],
	...
	/* --------------------------------- */
	/* Inquiries 'Mark as' sweetelert
	/* --------------------------------- */

		markInquiryAs: function () {
			$('.mark-inquiry-as').click(function() {
