...
@permission(['manage-curves','view-dashboard-quick-stats'])
<!-- Stat Tile  -->
...
@permission(['manage-curves','view-dashboard-members-tab'])
    <div class="col-lg-6">
        <div class="panel">
                            ...
                            <table class="table table-hover table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     @permission(['manage-curves','manage-subscriptions','renew-subscription'])
                                    <td>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @permission(['manage-curves','manage-subscriptions','cancel-subscription'])
...
@permission(['manage-curves','view-dashboard-inquiries-tab'])
<!--Inquiry Quick view Tabs-->
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-title">
                <div class="panel-head"><i class="fa fa-phone"></i><a href="{{ action('InquiriesController@index') }}">Inquiries</a></div>
                <div class="pull-right"><a href="{{ action('InquiriesController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-phone"></i> Add</a></div>
            </div>

            <div class="panel-body with-nav-tabs">
                <!-- Tabs Heads -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#inquiries" data-toggle="tab">Inquiries</a></li>
                    <li><a href="#reminders" data-toggle="tab">Reminders<span class="label label-warning margin-left-5">{{ $reminderCount }}</span></a></li>
                </ul>

                <!-- Tab Content -->
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="inquiries">
                        <div class="table-responsive <?php echo (!$inquiries->isEmpty() ? "panel-scroll" : "") ?>">
                            <table class="table table-hover table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ action('InquiriesController@show',['id' => $inquiry->id]) }}">{{ $inquiry->email }}</a></td>
                                    <td><a href="{{ action('InquiriesController@show',['id' => $inquiry->id]) }}">{{ $inquiry->contact }}</a></td>
                                </tr>
                                @empty
                                   <div class="tab-empty-panel font-size-24 color-grey-300">
                                        No Data
                        ...
                        <a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('InquiriesController@index') }}">View All</a>
                        @endif
                    </div>
                    ...
                    <div class="tab-pane fade" id="reminders">
                            <div class="table-responsive <?php echo (!$reminders->isEmpty() ? "panel-scroll" : "") ?>">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td><a href="{{ action('InquiriesController@show',['id' => $reminder->inquiry->id]) }}">{{ $reminder->inquiry->name }}</a></td>
                                        <td><a href="{{ action('InquiriesController@show',['id' => $reminder->inquiry->id]) }}">{{ $reminder->inquiry->contact }}</a></td>
                                        <td><a href="{{ action('InquiriesController@show',['id' => $reminder->inquiry->id]) }}">{{ $reminder->due_date->format('Y-m-d') }}</a></td>
                                        <td><a href="{{ action('InquiriesController@show',['id' => $reminder->inquiry->id]) }}">{{ Utilities::getFollowupBy ($reminder->followup_by) }}</a></td>
                                    </tr>
                                    @empty
                                       <div class="tab-empty-panel font-size-24 color-grey-300">
                                            No Data
...
@permission(['manage-curves','view-dashboard-charts'])
    <div class="col-lg-6">
        <div class="panel bg-white">
            ...
            <div class="panel-body padding-top-10">
                ...
                <div id="curves-members-per-plan" class="chart"></div>
                @else
                  <div class="tab-empty-panel font-size-24 color-grey-300">
                  <div id="curves-members-per-plan" class="chart"></div>
                        No Data
    ...
    <div class="col-lg-12">
        <div class="panel bg-white">
            ...
            <div class="panel-body no-padding-top">
                <div id="curves-registrations-trend" class="chart"></div>
            </div>
        </div>
    </div>
</div>
