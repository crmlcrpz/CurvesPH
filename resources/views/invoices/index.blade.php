                        ...
                        <div class="row"> 
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        <div id="invoice-daterangepicker" class="curves-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
                ...
                <tbody>              
                  @foreach ($invoices as $invoice)
                    ...
                    <td>
                      ...
                      @permission(['manage-curves','manage-invoices','add-discount'])
                      <li>
                      ...
                      @endif
                      <li>
                      @permission(['manage-curves','manage-invoices','delete-invoice'])
