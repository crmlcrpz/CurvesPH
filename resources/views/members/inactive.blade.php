...
<div class="rightside bg-grey-100">
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">Archives
                        ...
                        <div class="row"> 
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        <div id="member-daterangepicker" class="curves-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
                            ...
                            <?php 
                             ...
                             ?>
                                <tr>
                                    ...
                                    <li>
                                        @permission(['manage-curves','manage-members','edit-member'])
                                        <a href="{{ action('MembersController@edit',['id' => $member->id]) }}">Edit details</a>
                                        @endpermission
                                    </li>
                                    <li>
                                        @permission(['manage-curves','manage-members','delete-member'])
