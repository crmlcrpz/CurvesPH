...
<div class="container-fluid">
 ...
 {!! Form::hidden('transfer_id',$inquiry->id) !!}
						...
						<div class="panel no-border">
                            ...
                            <div class="panel-head font-size-20">Enter details of the member</div>
                                ...
                                <div class="panel-body">
                                    ...
                                    {!! Form::text('name',$inquiry->name,['class'=>'form-control', 'id' => 'name']) !!}
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    {!! Form::text('DOB',$inquiry->DOB,['class'=>'form-control datepicker', 'id' => 'DOB']) !!}
                                        </div>
                                        </div>
                                    ...
                                    {!! Form::text('contact',$inquiry->contact,['class'=>'form-control', 'id' => 'contact']) !!}
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                        {!! Form::label('email','Email') !!}
                                    {!! Form::text('email',$inquiry->email,['class'=>'form-control', 'id' => 'email']) !!}
                                        </div>
                                        </div>
                                 </div>
                            ...
                            <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    {!! Form::text('pin_code',$inquiry->pin_code,['class'=>'form-control', 'id' => 'pin_code']) !!}
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    {!! Form::select('aim',array('0' => 'Fitness', '1' => 'Networking', '2' => 'Body Building', '3' => 'Fatloss', '4' => 'Weightgain', '5' => 'Others'),$inquiry->aim,['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'aim']) !!}
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                    {!! Form::label('source','How do you came to know about us?',['class'=>'control-label']) !!}
                                    {!! Form::select('source',array('0' => 'Promotions', '1' => 'Word Of Mouth', '2' => 'Others'),$inquiry->source,['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'source']) !!}
                                        </div>
                                        </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    ...
                                    {!! Form::textarea('address',$inquiry->address,['class'=>'form-control', 'id' => 'address']) !!}
                                        </div>
                                        </div>
                                 </div>
                                 </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('payment_amount_pending',null,['class'=>'form-control', 'id' => 'payment_amount_pending', 'readonly']) !!}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    {!! Form::select('mode',array('1' => 'Cash', '0' => 'Card'),1,['class'=>'form-control selectpicker show-tick', 'id' => 'mode']) !!}
                                    </div>
                                </div>
                            </div> <!-- /Row -->
                </div> <!-- /Panel-body -->
