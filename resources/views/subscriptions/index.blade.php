                        ...
                        <div class="row"> 
                                <div class="col-sm-12 no-padding">
                                    {!! Form::Open(['method' => 'GET']) !!}
                                        ...
                                        <div id="subscription-daterangepicker" class="curves-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
...
<li>
@permission(['manage-curves','manage-subscriptions','edit-subscription'])
<a href="{{ action('SubscriptionsController@edit',['id' => $subscription->id]) }}">
Edit details                                          
</a>
@endpermission
</li>
@permission(['manage-curves','manage-subscriptions','change-subscription'])
<li>
...
<li>
@endpermission
@permission(['manage-curves','manage-subscriptions','delete-subscription'])
