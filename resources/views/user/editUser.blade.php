    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                <?php 
                $withoutCurves = App\Role::where('name','!=','Curves')->lists('name', 'id'); 
                $withCurves = App\Role::lists('name','id');
                ?>
                {!! Form::label('Role') !!}
                {!! Form::select('role_id',(Auth::User()->hasRole('Curves') ? $withCurves : $withoutCurves),$user->role_user->role_id,['class'=>'form-control selectpicker show-tick', 'id' => 'role_id']) !!}
                </div>                              
                </div>
                </div>                                        
                </div>
